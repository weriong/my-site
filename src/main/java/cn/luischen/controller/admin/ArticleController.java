...
public class ArticleController extends BaseController {
    ...
    @ApiOperation(value = "文章页",notes = "文章页")
    @GetMapping(value = "")
    public String index(
    ...
    @ApiOperation(value = "发布文章页",notes = "发布文章页")
    ...
    @ApiOperation( value = "发布新文章",notes = "发布新文章")
    ...
    @ApiOperation(value = "文章编辑页",notes = "文章编辑页")
    ...
    @ApiOperation( value = "编辑保存文章",notes = "编辑保存文章")
    @PostMapping("/modify")
    @ResponseBody
